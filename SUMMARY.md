...
* [🤳 Compatible Wallets](use-phi-smart-chain/compatible-wallets/README.md)
  * [🏦 PHI Wallet Setup](use-phi-smart-chain/compatible-wallets/phi-wallet-setup/README.md)
    * [🔃 Import PHI Network Profile Wallet To PHI Smart Chain Wallet.](use-phi-smart-chain/compatible-wallets/phi-wallet-setup/import-phi-network-profile-wallet-to-phi-smart-chain-wallet..md)
  * [🏦 Additional Wallets Setup](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/README.md)
    * [ℹ Metamask Setup](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/metamask-setup/README.md)
      * [⤵ Install Metamask](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/metamask-setup/install-metamask.md)
    * [ℹ Token Pocket Setup](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/token-pocket-setup.md)
    * [ℹ Coinbase Setup](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/coinbase-setup.md)
    * [ℹ Brave Setup](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/brave-setup.md)
    * [ℹ Alpha Wallet Setup](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/alpha-wallet-setup.md)
    * [ℹ ImToken Setup](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/imtoken-setup.md)
    * [🔌 Connect With Chainlist](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/connect-with-chainlist.md)
    * [↕ How To Import A Wallet Into Another Wallet?](use-phi-smart-chain/compatible-wallets/additional-wallets-setup/how-to-import-a-wallet-into-another-wallet.md)
